...
restart_btn = Button(restart_img, (40,40), 720, 245)

l1=pygame.image.load('Assets/l1.png')
l1_btn = Button(l1, (50,50), 660, 190)

l2=pygame.image.load('Assets/l2.png')
l2_btn = Button(l2, (50,50), 720, 190)

l3=pygame.image.load('Assets/l3.png')
l3_btn = Button(l3, (50,50), 780, 190)


info_img = pygame.image.load('Assets/info.png')
info_btn = Button(info_img, (40,40), 720, 295)

close_img = pygame.image.load('Assets/close.png')
close_btn = Button(close_img, (40,40), 720, 345)
